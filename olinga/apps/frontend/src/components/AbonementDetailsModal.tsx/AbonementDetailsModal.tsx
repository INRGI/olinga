...
import {
  ...
  ImageContainer,
  DateContainer,
} from '../MassageDetailsModal/MassageDetailsModal.styled';
import { useTranslation } from 'react-i18next';
import { CloseButton } from '../Modal/Modal.styled';
import { Abonement } from '../../pages/AdminDashboard/AbonementService';

interface AbonementsDetailsModalProps {
  isOpen: boolean;
  onClose: () => void;
  initialData: Abonement | null;
}

const AbonementsDetailsModal: React.FC<AbonementsDetailsModalProps> = ({
  isOpen,
  onClose,
  initialData,
}) => {
...
export default AbonementsDetailsModal;
